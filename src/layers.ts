...
export const baseLayer = new MaplibreLayer({
  apiKey: import.meta.env.VITE_API_KEY,
});

export const routeLayer = new MaplibreStyleLayer({
  beforeId: BEFORE_ID,
...
export const alrosLayer = new MaplibreStyleLayer({
  beforeId: BEFORE_ID,
  maplibreLayer: baseLayer,
  sources: {
    [ALROS_LAYER_SOURCE_ID]: {
...
export const alroLayer = new MaplibreStyleLayer({
  maplibreLayer: baseLayer,
  sources: {
    [ALRO_LAYER_SOURCE_ID]: {
      data: {
...
export default [baseLayer, routeLayer, alrosLayer, alroLayer];
